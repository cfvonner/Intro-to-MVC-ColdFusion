<cfoutput>
    ...
    <div class="container space-bottom">
        <a class="btn btn-light btn-sm" href="#BuildURL( action='beer.add' )#" role="button">
                ...
                <cfloop query="rc.beers">
                    <tr>
                        ...
                        <td class="text-center text-nowrap">
                            <a class="btn btn-light btn-sm" href="#BuildURL( action='beer.edit', queryString='beerId=#rc.beers.id#' )#" title="Edit" role="button">
                                <i class="fa-regular fa-pen-to-square text-success" aria-hidden="true"></i>
                            </a>
                            &nbsp;
                            <a class="btn btn-light btn-sm" href="#BuildURL( action='beer.delete', queryString='beerId=#rc.beers.id#' )#" title="Delete" role="button">
