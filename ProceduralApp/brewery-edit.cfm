...
<cfelseif StructKeyExists( request, "submit" ) AND request.breweryId EQ 0>
    ...
    <cfset subtitle = "Edit """ & request.breweryName & """ Brewery">
<cfelseif !StructKeyExists( request, "submit" ) AND request.breweryId GT 0>
    ...
    <cfset subtitle = "Edit """ & getBrewery.name & """ Brewery">
<cfelse>
    <cfset subtitle = "Add New Brewery">
</cfif>
    ...
    <body role="document">
        <cfoutput>
            <div class="container" role="main">
                ...
                <div class="container">
                    <form class="form-horizontal" action="brewery-edit.cfm"
                        name="breweryForm" method="post"> <!---enctype="multipart/form-data">--->
                        
                        <input id="breweryId" name="breweryId" type="hidden" value="#request.breweryId#">
                        <div class="form-group">
                            <label for="breweryName" class="col-sm-2 control-label">Name</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="breweryCity" class="col-sm-2 control-label">City</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="breweryState" class="col-sm-2 control-label">State</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="breweryCountry" class="col-sm-2 control-label">Country</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <!---<div class="btn-group" role="group">--->
                                    ...
                                    <a href="brewery-list.cfm" class="btn btn-warning" role="button">Cancel</a>
                                <!---</div>--->
                            </div>
                        </div>
