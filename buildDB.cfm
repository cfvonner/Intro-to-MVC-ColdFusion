...
<cfscript>
    function createDatabase() {
        ...
        SQL = "CREATE TABLE Venue (
                    id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY CONSTRAINT Venue_PK PRIMARY KEY
                    ,name VARCHAR(100)
                    ,city VARCHAR(100)
                    ,state VARCHAR(100)
                    ,country VARCHAR(100)
        ...
        SQL = "CREATE TABLE Checkin (
                    id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY CONSTRAINT Checkin_PK PRIMARY KEY
                    ,date DATE
                    ,comment VARCHAR(140)
                    ,score DEC (3,2)
                    ,flavorProfiles VARCHAR(100)
                    ,servingType VARCHAR(20)
                    ,venueId INT
                    ,purchaseVenueId INT
                )";
        ...
        var venueObj = new MVCAppFW1.model.services.venue( helperObj );
